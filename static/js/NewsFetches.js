    ...
    .then(data => {
        ...
        data.forEach(each => {
            ...
            if (photoPaths[0] === "No Photo") {
                ...
                news_image.src = `http://127.0.0.1:8000/news/upload?photo_path=${photoPaths[0]}`;
            }
            ...
            block_item.addEventListener('click', function() {
                ...
                opened_img.src = `http://127.0.0.1:8000/news/upload?photo_path=${photoPaths[0]}`;
                ...
                for (let i = 0; i < photoPaths.length; i++) {
                    ...
                    cl_image.src = `http://127.0.0.1:8000/news/upload?photo_path=${photoPaths[i]}`;
                    image_div.appendChild(cl_image);
                    closed_images.appendChild(image_div);

                    image_div.addEventListener('click', function() {
                        opened_img.src = `http://127.0.0.1:8000/news/upload?photo_path=${photoPaths[i]}`
                    });
                }
